(function($){
	...
	//var COLLAPSE_ALL_CODE = '<span class="' + CLASS_JQUERY_TREE_COLLAPSE_ALL + '">Hide All</span>';
  var COLLAPSE_ALL_CODE = '';
	//var EXPAND_ALL_CODE = '<span class="' + CLASS_JQUERY_TREE_EXPAND_ALL + '">Show All</span>';
  var EXPAND_ALL_CODE = '';
