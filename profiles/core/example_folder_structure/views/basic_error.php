  ...
  <body>
    <div id="aw_error">
    	...
    	<div id="<?php echo $env_id ?>" class="content collapsed">
    		...
    		<h3><a href="#<?php echo $env_id = $error_id.'environment_included' ?>" onclick="return toggle('<?php echo $env_id ?>')"><?php echo Literal::getPhrase('Debug Information', 'system'); ?></a> (<?php echo count($debugLog) ?>)</h3>
