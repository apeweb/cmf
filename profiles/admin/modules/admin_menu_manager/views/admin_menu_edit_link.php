    ...
    <div class="columns">
      ...
      <div class="left flexi_column clearfix">
        <div class="intro">
          <table>
            <tbody>
              <tr>
                <td style="width:50%;">
                  <h1 class="package"><?=View_Data::getValue('menu_link_name');?></h1>
                </td>
                <td align="right">
        ...
        <div class="panel active" id="settings">
          ...
          <div class="form-item">
            <label for="name">URL <span class="required">*</span></label><br />
            <input id="name" class="fluid input-text required" type="text" maxlength="255" value="<?=View_Data::getValue('menu_name');?>" name="name" /><br />
          ...
          <div class="form-item">
            ...
            <input id="name" class="fluid input-text" type="text" maxlength="255" value="<?=View_Data::getValue('menu_name');?>" name="name" /><br />
            When a visitor places the mouse cursor over the link, this is the text that will appear in the popup tooltip
            <div class="break"><br /><br /></div>
          </div>

          <div class="form-item">
            <label for="name">CSS Class</label><br />
            <input id="name" class="fluid input-text" type="text" maxlength="255" value="<?=View_Data::getValue('menu_name');?>" name="name" /><br />
          ...
          <div class="form-item">
            <label for="name">Parent Link</label><br />
            <select name=""><option>&lt;No Parent&gt;</option></select><br />
